...
class TransaksiResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Transaksi Umum';
    protected static ?string $modelLabel = 'Transaksi Umum';
    protected static ?string $pluralModelLabel = 'Transaksi Umum';
