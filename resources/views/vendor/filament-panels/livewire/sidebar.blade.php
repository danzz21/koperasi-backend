    ...
    >
        ...
        <div>
            <div style="padding:1rem 1.25rem;border-bottom:1px solid rgba(167,243,208,.18);">
                <div style="display:flex;align-items:center;gap:.6rem;">
                    ...
                    <div>
                        ...
                        <p style="margin:0;font-size:.6rem;color:rgba(167,243,208,.8);">Koperasi Syariah</p>
                    </div>
                </div>
            </div>
            ...
            <nav style="padding:.75rem .625rem;">
                ...
                {{-- Menu Utama --}}
                <p style="font-size:.6rem;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:rgba(167,243,208,.75);padding:.25rem .5rem .5rem;margin:0;">Menu Utama</p>
                ...
                {{-- Laporan & Sistem --}}
                <p style="font-size:.6rem;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:rgba(167,243,208,.75);padding:1rem .5rem .5rem;margin:0;">Laporan & Sistem</p>
                <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:2px;">
                ...
                {{-- Layanan Digital --}}
                <p style="font-size:.6rem;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:rgba(167,243,208,.75);padding:1rem .5rem .5rem;margin:0;">Layanan Digital</p>
                <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:2px;">
        ...
        <div style="margin:.75rem;padding:.75rem;border-radius:.75rem;background:rgba(6,78,59,.4);border:1px solid rgba(16,185,129,.2);">
            <div style="display:flex;align-items:center;gap:.6rem;">
                ...
                <div style="flex:1;min-width:0;">
                    <p style="font-size:.72rem;font-weight:700;color:#fff;margin:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">{{ filament()->auth()->user()?->name ?? 'Administrator' }}</p>
                    <p style="font-size:.62rem;color:rgba(167,243,208,.8);margin:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">{{ filament()->auth()->user()?->email ?? 'admin@koperasi.com' }}</p>
                </div>
            </div>
        </div>
